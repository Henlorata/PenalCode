// FrakHub/src/layouts/McbLayout.tsx

import { Outlet, Navigate, useLocation, Link } from "react-router-dom";
import { useAuth } from "@/context/AuthContext";
import { Loader2, Shield, UserCog, LogOut } from "lucide-react";
...
export function McbLayout() {
  ...
  return (
    <div className="text-white min-h-screen flex flex-col">
      ...
      {/* === VÁLTOZÁS ITT === */}
      {/* Az SfsdLayout-ból átvett stílusok:
        w-full, max-w-screen-2xl, mx-auto, p-4, md:p-8

        Az eredeti stílusok megtartva:
        flex-1, flex-col, min-h-0
      */}
      <main className="flex-1 flex flex-col min-h-0 w-full max-w-screen-2xl mx-auto p-4 md:p-8">
        <Outlet />
      </main>
      {/* === VÁLTOZÁS VÉGE === */}
    </div>
